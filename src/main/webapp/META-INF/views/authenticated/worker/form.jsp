...
<acme:form>
	...
	<acme:form-submit test="${command == 'create'}" code="authenticated.worker.form.label.create"
		action="/authenticated/worker/create" />
	<acme:form-submit test="${command == 'update'}" code="authenticated.worker.form.label.update"
